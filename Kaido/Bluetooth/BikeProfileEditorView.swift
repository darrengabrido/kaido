        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("Kaido keeps Mapbox's cycling route and guidance, then adjusts the displayed time to this pace.")
                }
                ...
                Section {
                    ...
                    Text("This removes the saved bike and its pairing details from Kaido. A replacement active bike will be selected automatically.")
                }
            }
